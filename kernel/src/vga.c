...
// @note - 8x8 bits * 256 times = (8*8/8)*256 = 2048
...
void vga_mode_text()
{
    ...
    write_font(g_8x8_font, sizeof(g_8x8_font));
}

// NOLINTBEGIN(readability-magic-numbers)
static uint8_t g_8x8_font[2048] = /* Definition for the previously declared variable */
{
